# Contributing to tablexlsx development

The goal of this guide is to help you get up and contributing to
`tablexlsx` as quickly as possible. The guide is divided into two main
pieces:
...
1.  **Motivation**. Your pull request should clearly and concisely
    ...
    tablexlsx comes out it’s easy for users to see what’s changed. Add
